...
import 'package:sentinel/chat/widgets/my_message_card.dart';
import 'package:sentinel/chat/widgets/sender_message_card.dart';
      ...
      builder: (context, snapshot) {
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            var timeSent = DateFormat("h:mma").format(messageData.timeSent);

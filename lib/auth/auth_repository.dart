...
import 'package:sentinel/repositories/common_firebase_storage_repository.dart';
import 'package:sentinel/screens/otp_screen.dart';
import 'package:sentinel/utils/utils.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';
import '../app_screens/mobile_layout_screen.dart';
...
class AuthRepository {
  ...
  void saveUserDataToFirebase({
    ...
    required BuildContext context}) async {
      try {
        ...
        Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: ((context) => MobileLayoutScreen())), (route) => false);
      } catch(e) {
  ...
  Stream<UserModel>userData(String userId) {
    ...
    .doc(userId)
    .snapshots().map((event) => UserModel.fromMap(
      event.data()!,
      ));
  }
